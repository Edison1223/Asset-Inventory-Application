          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => UserManageProfile(userId: widget.userId)),
              ),
            ),
            ListTile(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const NotificationsAndAlertsPage()),
              ),
            ),
            ListTile(
